        ...
        <div className="grid gap-6 py-4">
          <div className="space-y-4 border-b border-slate-800 pb-4">
            <h4 className="text-sm font-semibold flex items-center gap-2">
              <ImageIcon className="w-4 h-4" /> Static Image Export
            </h4>
                ...
                <div className="flex bg-slate-800 p-1 rounded-xl">
                  {[1, 2, 4, 8].map((s) => (
                    <button
                      ...
                      className={`flex-1 text-xs py-1.5 rounded-lg transition-colors ${pngScale === s ? "bg-indigo-500 text-white shadow" : "text-slate-400 hover:text-slate-200"}`}
                    >
                      {s === 1
                        ? "1x"
                        : s === 2
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-semibold flex items-center gap-2">
              <Video className="w-4 h-4" /> Animated GIF Export
            </h4>
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <select
                  className="w-full bg-slate-800 rounded-xl px-2 py-1.5 text-sm border border-slate-700 text-slate-200 focus:outline-none focus:ring-2 focus:ring-primary"
                  value={gifScale}
